...
if(empty($nama)){
    ...
    echo "<script>alert('No Telfon tidak boleh kosong');location.href='tampil_pelanggan.php';</script>";
}else {
    include "koneksi2.php";
    $update=mysqli_query($conn,"update pelanggan set
        nama='".$nama."',alamat='".$alamat."',telp='".$telp."', id_pelanggan='".$id_pelanggan."' where id_pelanggan =
